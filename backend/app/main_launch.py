...
app.version = "0.3.0"
app.description = (
    "Launch-oriented Sports Terminal API for NBA data releases, users, "
    "organizations, transaction workflows, saved sports objects, workspaces, "
    "content, messaging, billing placeholders, and platform operations."
)
