  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Wrap(alignment: WrapAlignment.spaceBetween, runSpacing: 12, children: [
        SizedBox(
          width: 480,
          child: Text('Sports Terminal is an NBA-first sports intelligence, fantasy, community, and workspace platform under active development.', style: TextStyle(color: palette.muted, height: 1.4, fontWeight: FontWeight.w600)),
        ),
