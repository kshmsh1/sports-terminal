      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: [
            ...
            const _StatusItem(label: 'STATE', value: 'READY'),
          ],
        ),
      ),
    );
...
class _StatusItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final tokens = TerminalDesignTokens.of(
      context,
      density: TerminalDensity.terminal,
    );
    return Text.rich(
      TextSpan(children: [
        TextSpan(
          text: '$label ',
          style: tokens.captionStyle.copyWith(fontWeight: FontWeight.w900),
        ),
