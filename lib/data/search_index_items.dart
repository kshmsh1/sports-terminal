...
const terminalSearchItems = <SearchIndexItem>[
  ...
  SearchIndexItem(title: 'Reports library', category: 'Core module', target: 'Reports', status: 'Planned', description: 'Reusable report templates for player, team, draft, awards, franchise, transaction, and development workflows.'),
