...
const gameWorkspaceItems = <WorkspaceBuildItem>[
  ...
  WorkspaceBuildItem(area: 'Player box scores', priority: 'P2', status: 'Planned', description: 'Player-level game production with minutes, usage, shooting, counting stats, and availability context.', firstDataNeed: 'Historical player game-log data.'),
  WorkspaceBuildItem(area: 'Playoff series', priority: 'P3', status: 'Future', description: 'Series-level matchup context, seeds, round, home-court status, game-by-game results, and advancement.', firstDataNeed: 'Playoff bracket and series records.'),
];
...
const awardWorkspaceItems = <WorkspaceBuildItem>[
  ...
  WorkspaceBuildItem(area: 'Voting shares', priority: 'P3', status: 'Future', description: 'Vote shares, ranks, points, first-place votes, and voting body context.', firstDataNeed: 'Detailed voting tables.'),
];
