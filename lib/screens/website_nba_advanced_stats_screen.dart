  ...
  Widget _metricHeader(_Metric metric) {
    ...
    return InkWell(
      ...
      child: Row(
        ...
        children: [
          Icon(expanded ? Icons.arrow_drop_down_rounded : Icons.arrow_right_rounded, size: 29),
...
const _categories = <_Category>[
  ...
  _Category('Playmaking & Creation', 'Passing volume, creation quality, turnover control and advantage generation.', [
    ...
    _Metric('adj_ast_ratio', 'Adj. Assist Ratio', 'Adjusted assist ratio ending in an assist, free-throw assist, or secondary assist.'),
    ...
    _Metric('pass_windows_opened', 'Pass Windows', 'Passing lanes or windows created by the player when a tracking model provides the measure.'),
  ]),
  _Category('Defense', 'Defensive events, shot suppression, matchup results, hustle and foul discipline.', [
    _Metric('stl', 'SPG', 'Steals per game.', children: [_Metric('stl_pct', 'STL%', 'Steal percentage.', percent: true)]),
    _Metric('blk', 'BPG', 'Blocks per game.', children: [_Metric('blk_pct', 'BLK%', 'Block percentage.', percent: true)]),
    ...
    _Metric('contested_shots_pg', 'Contested Shots PG', 'Contested shots per game.'),
    ...
    _Metric('rim_dfg_pct', 'Rim DFG%', 'Opponent rim field-goal percentage when defended by this player.', percent: true),
    _Metric('three_dfg_pct', '3P DFG%', 'Opponent three-point percentage when defended by this player.', percent: true),
  ...
  _Category('Rebounding', 'Rebound volume, opportunity, contestedness, box-outs and deferred rebound value.', [
    _Metric('reb', 'RPG', 'Total rebounds per game.', children: [
  ...
  _Category('Impact', 'Team impact, on-court efficiency and all-in-one impact models.', [
    ...
    _Metric('on_off_net', 'On/Off Diff', 'Difference between team net rating with the player on and off the court.', signed: true),
  ...
  _Category('Rate Adjusted', 'Production normalized by minutes, possessions, pace and role.', [
  ...
  _Category('Clutch', 'Production and efficiency in source-defined clutch possessions.', [
    ...
    _Metric('clutch_efg_pct', 'Clutch eFG%', 'Clutch effective field-goal percentage.', percent: true),
    _Metric('clutch_ts_pct', 'Clutch TS%', 'Clutch true shooting percentage.', percent: true),
    _Metric('clutch_ortg', 'Clutch ORtg', 'Clutch offensive rating.'),
    _Metric('clutch_drtg', 'Clutch DRtg', 'Clutch defensive rating.'),
    _Metric('clutch_net', 'Clutch Net', 'Clutch net rating.', signed: true),
    _Metric('clutch_plus_minus', 'Clutch +/-', 'Clutch plus/minus.', signed: true),
  ]),
  _Category('Gravity & Spacing', 'Shot gravity, offensive attention, spacing and advantage creation.', [
    _Metric('gravity', 'Gravity', 'Source-backed offensive or shot gravity metric.'),
    ...
    _Metric('drive_gravity', 'Drive Gravity', 'Defensive attention created on drives.'),
    ...
    _Metric('offensive_gravity', 'Off. Gravity', 'Overall source-backed offensive gravity.'),
  ]),
  _Category('On / Off', 'On-court and off-court team performance splits.', [
  ...
  _Category('Lineups & Roles', 'Lineup context, usage, play type and role statistics.', [
  ...
  _Category('Movement & Physical', 'Movement load, touch behavior and physical measurements.', [
    _Metric('usg_pct', 'Usage', 'Usage percentage.', percent: true),
    ...
    _Metric('height', 'Height', 'Listed height.'),
    _Metric('weight', 'Weight', 'Listed weight.'),
...
double? _metricValue(NbaStatsRow row, String key) {
  ...
  const aliases = <String, List<String>>{
    ...
    'fgm': ['fgm', 'field_goals_made'], 'fga': ['fga', 'field_goal_attempts'], 'fg_pct': ['fg_pct'],
    'three_pm': ['fg3m', 'three_pm', 'three_pointers_made'], 'three_pa': ['fg3a', 'three_pa', 'three_point_attempts'],
    'three_pct': ['fg3_pct', 'three_pct'], 'ftm': ['ftm', 'free_throws_made'], 'fta': ['fta', 'free_throw_attempts'],
    'ft_pct': ['ft_pct'], 'efg_pct': ['efg_pct'], 'ts_pct': ['ts_pct'],
  ...
  final threeA = rawValue(['fg3a', 'three_pa', 'three_point_attempts']);
