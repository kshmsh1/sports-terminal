                  ...
                  builder: (context, constraints) {
                    ...
                    final form = AnimatedBuilder(
                      ...
                      builder: (context, _) => _Form(
                        ...
                        onPrivacy: (value) =>
                            setState(() => acceptedPrivacy = value),
  ...
  Widget build(BuildContext context) => const TerminalCard(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
              'A connected sports data, research, transaction, editorial and community operating system—starting with the NBA.',
              style: TextStyle(
            ...
            Wrap(
              ...
              runSpacing: 8,
              children: [
                InfoPill(label: 'NBA Research'),
                InfoPill(label: 'Linked Entities'),
                InfoPill(label: 'Trade Machine'),
                InfoPill(label: 'Python Lab'),
                InfoPill(label: 'Community'),
              ],
            ),
            SizedBox(height: 22),
            ...
            SizedBox(height: 16),
            Text(
              'One account connects your preferences, favorite teams, player watchlists, research context, workspaces, community identity and organization workflows.',
              style: TextStyle(color: terminalTextSoft, height: 1.5),
            ),
          ],
        ),
      );
...
class _Form extends StatelessWidget {
  ...
  final TextEditingController organizationName;
  ...
  final ValueChanged<bool> onOrganization;
        ...
        child: Column(
          ...
          children: [
            SegmentedButton<bool>(
              ...
              onSelectionChanged:
                  controller.busy ? null : (values) => onMode(values.first),
            ),
            const SizedBox(height: 18),
            Text(
            ...
            if (createAccount) ...[
              ...
              TextField(
                ...
                decoration: _field('Display name', Icons.badge_outlined),
              ),
              const SizedBox(height: 10),
              SwitchListTile.adaptive(
                contentPadding: EdgeInsets.zero,
                value: organizationAccount,
                onChanged: controller.busy ? null : onOrganization,
                title: const Text(
                ...
                subtitle: const Text(
                  'Shared members, cases, approvals and organization controls.',
            ...
            if (createAccount) ...[
              ...
              _LegalConsent(
                ...
                onChanged: onPrivacy,
                title: 'I acknowledge and agree to the Privacy Policy',
                onOpen: onOpenPrivacy,
              ),
              const SizedBox(height: 6),
              const Text(
                'Both agreements are required. Sports Terminal records the accepted legal-document version and acceptance timestamp with account creation.',
                style: TextStyle(
            ...
            for (final session in controller.demoSessions)
              Material(
                ...
                child: ListTile(
                  ...
                  onTap: controller.busy ? null : () => onDemo(session),
                ),
              ),
          ],
        ),
