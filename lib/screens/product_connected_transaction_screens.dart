...
class ProductConnectedTradeMachineScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _ConnectedTool(
      ...
      body:
          'Use the live 2–5 team trade machine to inspect contracts, draft capital, exceptions and cash, route assets, and resolve CBA findings before creating a persistent transaction case.',
