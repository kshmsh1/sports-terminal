...
import 'product_trade_machine_release_screen.dart';
...
class ProductConnectedTradeMachineScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _ConnectedTool(
      ...
      body:
          'Use the live 2–5 team trade machine to inspect contracts, draft capital, rights, exceptions and cash, route transferable assets, and resolve CBA findings before creating a persistent transaction case.',
      child: ProductTradeMachineReleaseScreen(session: session),
    );
  }
}
