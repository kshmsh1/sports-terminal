...
def request_contracts() -> dict[str, object]:
    return {
        "contract": "sports-terminal-nba-com-confirmed-requests-v5",
...
def main() -> int:
    ...
    parser.add_argument("--surface", choices=("players_advanced","players_advanced_box_scores","teams_advanced_box_scores","lineups_advanced"), default="players_advanced")
