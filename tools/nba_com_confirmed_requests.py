...
PLAYERS_ADVANCED_GAME_LOGS_HEADERS: tuple[str, ...] = (
    ...
    "MIN", "E_OFF_RATING", "OFF_RATING", "sp_work_OFF_RATING", "E_DEF_RATING",
    ...
    "FGA_PG_RANK", "FG_PCT_RANK", "AVAILABLE_FLAG", "MIN_SEC", "TEAM_COUNT",
)

TEAMS_ADVANCED_GAME_LOGS_HEADERS: tuple[str, ...] = (
...
ADVANCED_GAME_LOGS_PARAMETER_DEFAULTS: "OrderedDict[str, str]" = OrderedDict(
    [
...
def players_advanced_game_logs_url(**overrides: object) -> str:
    return f"{STATS_ORIGIN}{PLAYERS_ADVANCED_GAME_LOGS_ENDPOINT}?{urlencode(players_advanced_game_logs_params(**overrides))}"


def teams_advanced_game_logs_params(**overrides: object) -> OrderedDict[str, str]:
    return _params(TEAMS_ADVANCED_GAME_LOGS_PARAMETER_DEFAULTS, overrides)


def teams_advanced_game_logs_url(**overrides: object) -> str:
    return f"{STATS_ORIGIN}{TEAMS_ADVANCED_GAME_LOGS_ENDPOINT}?{urlencode(teams_advanced_game_logs_params(**overrides))}"
...
def request_contracts() -> dict[str, object]:
    return {
        "contract": "sports-terminal-nba-com-confirmed-requests-v4",
        ...
        "requests": {
            "players_advanced": {
                "method": "GET", "host": "stats.nba.com", "path": PLAYERS_ADVANCED_ENDPOINT,
                "result_set": PLAYERS_ADVANCED_RESULT_SET,
                "parameters": dict(PLAYERS_ADVANCED_PARAMETER_DEFAULTS),
            },
            "players_advanced_box_scores": {
                "method": "GET", "host": "stats.nba.com", "path": PLAYERS_ADVANCED_GAME_LOGS_ENDPOINT,
                ...
                "parameters": dict(PLAYERS_ADVANCED_GAME_LOGS_PARAMETER_DEFAULTS), "grain": "player-game",
            },
            "teams_advanced_box_scores": {
                "method": "GET", "host": "stats.nba.com", "path": TEAMS_ADVANCED_GAME_LOGS_ENDPOINT,
                "resource": TEAMS_ADVANCED_GAME_LOGS_RESOURCE,
                "result_set": TEAMS_ADVANCED_GAME_LOGS_RESULT_SET,
                "headers": list(TEAMS_ADVANCED_GAME_LOGS_HEADERS),
                "parameters": dict(TEAMS_ADVANCED_GAME_LOGS_PARAMETER_DEFAULTS), "grain": "team-game",
            },
        },
...
def main() -> int:
    ...
    parser.add_argument("--surface", choices=("players_advanced", "players_advanced_box_scores", "teams_advanced_box_scores"), default="players_advanced")
