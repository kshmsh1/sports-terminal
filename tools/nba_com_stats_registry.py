...
SURFACES: dict[str, NbaStatsSurface] = {
    "players_advanced": _surface(
        ...
        "player",
        "advanced",
        "/stats/players/advanced",
        "player-season filtered aggregate",
        "1996-97",
    ...
    "players_misc": _surface(
        ...
        endpoint_hint="leaguedashplayerstats", measure_type_hint="Misc", discovery_status="har_confirmation_required",
    ),
    "players_scoring": _surface(
        "players_scoring", "Players / General / Scoring", "player", "scoring", "/stats/players/scoring", "player-season filtered aggregate", "1996-97",
        endpoint_hint="leaguedashplayerstats", measure_type_hint="Scoring", discovery_status="har_confirmation_required",
    ),
    "players_usage": _surface(
        "players_usage", "Players / General / Usage", "player", "usage", "/stats/players/usage", "player-season filtered aggregate", "1996-97",
        endpoint_hint="leaguedashplayerstats", measure_type_hint="Usage", discovery_status="har_confirmation_required",
    ),
    "players_opponent": _surface(
        "players_opponent", "Players / General / Opponent", "player", "opponent", "/stats/players/opponent", "player-season filtered aggregate", "1996-97",
        endpoint_hint="leaguedashplayerstats", measure_type_hint="Opponent", discovery_status="har_confirmation_required",
    ),
    "players_defense": _surface(
        "players_defense", "Players / General / Defense", "player", "defense", "/stats/players/defense", "player-season filtered aggregate", "1996-97",
        endpoint_hint="leaguedashplayerstats", measure_type_hint="Defense", discovery_status="har_confirmation_required",
    ),
    ...
    "players_advanced_box_scores": _surface(
        ...
        "Players / Advanced Box Scores / Advanced",
        "player",
        "advanced_box_score",
